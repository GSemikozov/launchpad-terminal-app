...
export class JupiterAPI {
   ...
   */
  deserializeTransaction(swapTransaction: string): Transaction | VersionedTransaction {
    let transactionBuf: Uint8Array;
    try {
      transactionBuf = new Uint8Array(bs58.decode(swapTransaction));
    } catch {
      transactionBuf = new Uint8Array(Buffer.from(swapTransaction, 'base64'));
    }
